...
import 'schema/db_compras_record.dart';
...
export 'schema/db_compras_record.dart';
...
/// Functions to query DbComprasRecords (as a Stream and as a Future).
Future<int> queryDbComprasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DbComprasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DbComprasRecord>> queryDbComprasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DbComprasRecord.collection,
      DbComprasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DbComprasRecord>> queryDbComprasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
